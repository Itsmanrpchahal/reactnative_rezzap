...
const UpdateProfile = (props: any) => {
  ...
  const {profilePictureData, picture_loading} = useTypedSelector(
    state => state.profilePictureData,
  );
  const [value, setValue] = useState(1);
  const [stime, setSTime] = useState<any>(
    myProfileData ? myProfileData.data.dob : '',
  );
  const [profiledesgination, setProfileDesgination] = useState(
    myProfileData ? myProfileData.data.designation.toString() : '',
  );
        ...
        <ParentWrapper>
          ...
          <Formik
            ...
            initialValues={{
              ...
              account_type: myProfileData
                ? myProfileData.data.account_type
                : '',
            ...
            {({setFieldValue, handleSubmit, errors, values}) => (
              <View>
                ...
                />
                <Genderhearder>State</Genderhearder>
                <Horizontal>
                  <Dropdown
                    style={{
                      width: '100%',
                ...
                <Genderhearder>Visibilty</Genderhearder>
                ...
                <Horizontal>
                  <Dropdown
                    ...
                    placeholder={
                      myProfileData
                        ? myProfileData.data.visibility === '0'
                          ? 'Public'
                          : 'Private'
                        : ''
                    }
                ...
                <Genderhearder>Designation</Genderhearder>
                ...
                <Horizontal>
                  <Dropdown
                    ...
                    searchPlaceholder={'Search'}
                    placeholder={
                      profiledesgination === '0'
                        ? 'Student'
                        : profiledesgination === '1'
                        ? 'Parent'
                        : profiledesgination === '2'
                        ? 'College Counselor'
                        : profiledesgination === '3'
                        ? 'Admissions - College'
                        : profiledesgination === '4'
                        ? 'Recruiter'
                        : profiledesgination === '5'
                        ? 'Company'
                        : 'Coach'
                    }
                ...
                <Genderhearder>Account Type</Genderhearder>
                <Horizontal>
                  <Dropdown
                    style={{
                      width: '100%',
                    ...
                    placeholder={
                      myProfileData
                        ? myProfileData.data.account_type === '1'
                          ? 'Individual'
                          : 'My Spin'
                        : ''
                    }
                ...
                <Genderhearder>Date of birth</Genderhearder>
                ...
                <TouchableOpacity
                  ...
                  <Horizontal>
                    <TimeText>{format(new Date(stime), 'yyyy-MM-dd')}</TimeText>
                  </Horizontal>
                </TouchableOpacity>
                ...
                <Genderhearder>Gender</Genderhearder>
                <RadioWrapper>
                  <RadioForm
                    radio_props={radio_props}
                    initial={
                      myProfileData
                        ? parseInt(myProfileData.data.gender) - 1
                        : ''
                    }
                    formHorizontal={true}
                    buttonColor={'#000000'}
