...
import {demoImage, dummy, imageLayout, loc} from '../../../../utils/assets';
      ...
      {loading ? (
        ...
        <ChildWrapper>
            ...
            <ImageWrapper>
              ...
              <ImageBottom
                source={{
                  uri:
                    myProfileData != null
                      ? myProfileData.data.profile_photo != ''
          ...
          <ProfileItem
            ...
            decs={
              myProfileData != null
                ? myProfileData.data.gender === '1'
                  ? 'Male'
                  : myProfileData.data.gender === '2'
                  ? 'Female'
                  : 'Other'
                : ''
            }
          ...
          <ProfileItem
            ...
            decs={
              myProfileData != null
                ? myProfileData.data.designation === '0'
                  ? 'Student'
                  : myProfileData.data.designation === '1'
                  ? 'Parent'
                  : myProfileData.data.designation === '2'
                  ? 'College Counselor'
                  : myProfileData.data.designation === '3'
                  ? 'Admissions - College'
                  : myProfileData.data.designation === '4'
                  ? 'Recruiter'
                  : myProfileData.data.designation === '5'
                  ? 'Company'
                  : myProfileData.data.designation === '5'
                  ? 'Company'
                  : ''
